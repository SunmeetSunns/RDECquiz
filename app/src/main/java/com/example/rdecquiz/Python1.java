...
public class Python1 extends AppCompatActivity implements View.OnClickListener{
    TextView totalques;
    TextView ques;
    Button AnsA;
    Button AnsB;
    ...
    Button submit;
    int score;
    int TotalQuestion=Questions.QuestionsP.length;
    String selAns="";
    int Index=0;
    ...
    private void loadNewQues() {
        ...
        ques.setText(Questions.QuestionsP[Index]);
        AnsA.setText(Questions.ChoicesP[Index][0]);
        AnsB.setText(Questions.ChoicesP[Index][1]);
        AnsC.setText(Questions.ChoicesP[Index][2]);
        AnsD.setText(Questions.ChoicesP[Index][3]);
    }
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.Submit){
            if(selAns.equals(Questions.AnswersP[Index])){
                score++;
            }
            Index++;
            loadNewQues();
